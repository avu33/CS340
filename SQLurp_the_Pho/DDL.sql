-- Group 21
-- Annabel Vu and Lorine Mijares
-- SQLurp the Pho: Fast Casual Restaurant Management System


-- Disable commits and foreign key checks to minimize errors during import

SET FOREIGN_KEY_CHECKS=0;
SET AUTOCOMMIT = 0;


-- Clear out tables if they already exist in the database
